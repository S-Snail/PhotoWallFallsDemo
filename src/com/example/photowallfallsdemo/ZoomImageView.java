...
public class ZoomImageView extends View {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		/**
		 * Android中用一个32位整型值表示一次TouchEvent事件，低8位表示touch事件的具体动作，第二个8位表示触控点
		 * event.getAction()低8位   表示touch的具体动作
		 * event.getActionMasked()  16位 低8位表示touch动作,第二个8位表示触控点
		 * 如：0x0000 表示第一个触控点
		 * 	  0x0100表示第二个触控点 
		 */
